...
public class NodeLiteral extends Node {
    ...
    static NodeLiteral fromBoolean(boolean val) {
        return new NodeLiteral(
                EpType.EpIrreducibleLiteral, null, null, null, null, new BoolData(val));
    }

    static NodeLiteral fromString(String val) {
        return new NodeLiteral(
                EpType.EpIrreducibleLiteral, null, null, null, null, new StringData(val));
    }

    static NodeLiteral fromDouble(double val) {
        return new NodeLiteral(
                EpType.EpIrreducibleLiteral, null, null, null, null, new DoubleData(val));
    }

    static NodeLiteral fromInt(int val) {
        return new NodeLiteral(
                EpType.EpIrreducibleLiteral, null, null, null, null, new IntData(val));
    }
